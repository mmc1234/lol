...
public class Demo1_7 {
    ...
    public void init() {
        this.frameBuffer = FrameBuffer.newInstance();
        ...
        this.mainProgram = ShaderProgram.newInstance(
                ResourceUtil.loadModuleText(Demo1_7.SHADERS_PATH + "simple_cam_vertex.glsl"),
                ResourceUtil.loadModuleText(Demo1_7.SHADERS_PATH + "simple_uv_fragment.glsl"));
    ...
    public void renderStart() {
        ...
        this.fboColor = new Texture2D(TextureFormat.R8G8B8A8_UINT, 256, 256);
        this.fboColor.init();
        this.fboColor.reload();
        Texture2D.bindZero();

        this.frameBuffer.init();
        FrameBuffer.attachTexture2D(this.fboColor);
        FrameBuffer.chunk();
