...
public class Demo1_4 {
    ...
    List<VertexAttrib> defaultVertexAttribDescriptionList = VertexAttrib.list(TypeFormat.FLOAT32, 3);
    ...
    public void init() {
        ...
        this.mainProgram = ShaderProgram.newInstance(
                ResourceUtil.loadModuleText(Demo1_4.SHADERS_PATH + "simple_3d_vertex.glsl"),
                ResourceUtil.loadModuleText(Demo1_4.SHADERS_PATH + "simple_3d_fragment.glsl"));
